                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="fname" class=" form-control-label">Title</label></div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="lname" class=" form-control-label">Plan</label></div>
                                            <div class="col-12 col-md-9">
                                                <textarea class="form-control" id="content" name="content" value="content" placeholder="Planning Description" cols="5" rows="4">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="fname" class=" form-control-label">City</label></div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="fname" class=" form-control-label">Club</label></div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="dob" class=" form-control-label">Date</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="date" id="date1" name="date1" placeholder="YYYY-MM-DD" class="form-control" value="date1">
                                            </div>
                                        </div>
